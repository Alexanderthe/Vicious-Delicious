...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=150mm]{./images/iCrash-UseCase-suDeployAndRun-Diagram.eps}
\normalsize}
\end{center}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=150mm]{./images/iCrash-UseCase-suGlobalCrisisHandling-Diagram.eps}
\normalsize}
\end{center}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=150mm]{./images/iCrash-UseCase-ugManageCrisis-Diagram.eps}
\normalsize}
\end{center}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=150mm]{./images/iCrash-UseCase-ugAdministrateTheSystem-Diagram.eps}
\normalsize}
\end{center}
...
\begin{center}
\scalebox{0.8}{
\includegraphics[width=150mm]{./images/iCrash-UseCase-ugSecurelyUseSystem-Diagram.eps}
\normalsize}
\end{center}
