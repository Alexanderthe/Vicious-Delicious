...
\begin{usecase}
    ...
    \addnumberedsinglerow{}{\msrcode{RequestID:dtRequestID} - a unique identifier for a request.}
...
\begin{figure}[htbp]
\begin{center}
\scalebox{0.95}{\includegraphics[width=180mm]{./images/oeReplyToRequest.eps}\normalsize}
\end{center}
