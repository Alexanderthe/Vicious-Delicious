...
\begin{usecase}
    ...
    \addalphanumberedsinglerow{}{the actor \msrcode{actCoodinator} sends the message\msrcode{oeRequestEMSAssistance(dtComment AdtComment, dtRequestID AdtRequest, dtGPSLocation AdtGPSLocation, dtNbrofVehiculesInAccident AdtVehiculesInAccident, dtNbrOfVictims AdtNbrVictims,	ctEMStype ActEMSType)} to the system.}
...
\begin{figure}[htbp]
\begin{center}
\scalebox{0.95}{\includegraphics[width=180mm]{./images/oeRequestEMSAssistance.eps}\normalsize}
\end{center}
