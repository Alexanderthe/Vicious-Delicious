...
\begin{usecase}
    ...
    \addnumberedsinglerow{}{\msricrash system has been created and able to handled the crisis situations for which it received alerts through the communication company.}
    ...
    \addnumberedsinglerow{}{step (d) can be executed by different \msrcode{actCoordinator} actors.}
...
\begin{figure}[htbp]
\begin{center}
\scalebox{0.95}{\includegraphics[width=180mm]{./images/oeDeployAndRun.eps}\normalsize}
\end{center}
