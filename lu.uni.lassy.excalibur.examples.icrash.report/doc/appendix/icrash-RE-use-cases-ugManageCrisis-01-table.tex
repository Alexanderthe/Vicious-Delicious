...
\begin{usecase}
  ...
  \addsinglerow{The goal is to use all opperations available to the coordinator
  for the successful handling of a crisis or an alert recieved by our system.}
 ...
 \addrowheading{Protocol condition(s)}
  ...
  \addnumberedsinglerow{}{there exist one alert or one crisis whose related
